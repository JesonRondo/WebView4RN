...
import * as navigationbar from 'plugin/web/src/navigationbar';
...
export const invokePlugins = {
  install (context) {
    ...
    for (let key in navigationbar) {
      const bindPluginFn = navigationbar[key].bind(context);
      context.invoke.define(key, bindPluginFn);
    }
